...
exports.GenesisState = {
    ...
    fromJSON(object) {
        return {
            gen_txs: Array.isArray(object === null || object === void 0 ? void 0 : object.gen_txs)
                ? object.gen_txs.map((e) => bytesFromBase64(e))
                : [],
        };
    },
    toJSON(message) {
    ...
    fromPartial(object) {
        var _a;
        const message = createBaseGenesisState();
        message.gen_txs = ((_a = object.gen_txs) === null || _a === void 0 ? void 0 : _a.map((e) => e)) || [];
        return message;
    },
};
var globalThis = (() => {
